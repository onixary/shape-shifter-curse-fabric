...
public class MixinConfigPlugin implements IMixinConfigPlugin {
    ...
    static {
        ...
        mixinRequiredMods.put("net.onixary.shapeShifterCurseFabric.mixin.forge.CurioImpl", new MixinRequiredMods(new String[]{"curios", "connectormod"}, new String[]{}));
        mixinRequiredMods.put("net.onixary.shapeShifterCurseFabric.mixin.forge.CurioItemImpl", new MixinRequiredMods(new String[]{"curios", "connectormod"}, new String[]{}));
        mixinRequiredMods.put("net.onixary.shapeShifterCurseFabric.mixin.forge.CurioUtilsImpl", new MixinRequiredMods(new String[]{"curios", "connectormod"}, new String[]{}));
    }
