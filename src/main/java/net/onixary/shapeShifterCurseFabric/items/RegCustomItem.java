...
public class RegCustomItem {
    ...
    public static final Item SPIDER_FLUID_COCOON = register("spider_fluid_cocoon", new Item(new Item.Settings().maxCount(64).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.8f).alwaysEdible().snack().statusEffect(new StatusEffectInstance(StatusEffects.POISON, 600, 3), 1.0f).build())));
