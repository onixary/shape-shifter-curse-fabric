...
import static net.onixary.shapeShifterCurseFabric.ShapeShifterCurseFabric.LOGGER;
import static net.onixary.shapeShifterCurseFabric.ShapeShifterCurseFabric.MOD_ID;
import static net.onixary.shapeShifterCurseFabric.status_effects.RegTStatusEffect.removeEffects;
import static net.onixary.shapeShifterCurseFabric.status_effects.attachment.AttachmentStorage.loadAttachment;
import static net.onixary.shapeShifterCurseFabric.status_effects.attachment.AttachmentStorage.saveAttachment;
...
public class EffectManager {
    ...
    public static boolean saveCurrentAttachment(PlayerEntity player) {
        ...
        if(attachment != null) {
            ...
            saveAttachment(testUUID, attachment);
    ...
    public static boolean loadCurrentAttachment(PlayerEntity player) {
        // todo: 构建环境中UUID会变化，测试时使用固定的testUUID，发布时要改回
        PlayerEffectAttachment attachment = loadAttachment(testUUID);
