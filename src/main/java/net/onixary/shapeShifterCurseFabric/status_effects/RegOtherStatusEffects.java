...
public class RegOtherStatusEffects {
    ...
    public static final StatusEffect ENTANGLED_EFFECT = register("entangled_effect", new EntangledEffect(StatusEffectCategory.HARMFUL, 0x00FF00).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, "8c7b7e0c-3b0b-4e0d-8f4e-0c0e0d8c7b7e", -0.2F, EntityAttributeModifier.Operation.MULTIPLY_BASE));
    public static final StatusEffect ENTANGLED_FULL_EFFECT  = register("entangled_full_effect", new SimpleStatusEffect(StatusEffectCategory.HARMFUL, 0x00FF00).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, "8c7b7e0c-3b0b-4e0d-8f4e-0c0e0d8c7b7e", -1.0F, EntityAttributeModifier.Operation.MULTIPLY_BASE));
