...
public class RegPlayerForms {
    ...
    public static IForm BAT_2 = registerPlayerForm(new Form_Bat2(ShapeShifterCurseFabric.identifier("bat_2")).formFlag(HasSlowFall, NoInhibitor, LockInstinct, CursedMoonFinalForm, NoCatalyst, CanTFToFinalForm).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.5f, 1.0f)));
    ...
    public static IForm AXOLOTL_2 = registerPlayerForm(new Form_Axolotl2(ShapeShifterCurseFabric.identifier("axolotl_2")).formFlag(NoInhibitor, LockInstinct, CursedMoonFinalForm, NoCatalyst, CanTFToFinalForm).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.9f, 1.0f)));
    ...
    public static IForm OCELOT_2 = registerPlayerForm(new Form_Ocelot2(ShapeShifterCurseFabric.identifier("ocelot_2")).formFlag(NoInhibitor, LockInstinct, CursedMoonFinalForm, NoCatalyst, CanTFToFinalForm).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.65f, 1.0f)));
    ...
    public static IForm FAMILIAR_FOX_2 = registerPlayerForm(new Form_FamiliarFox2(ShapeShifterCurseFabric.identifier("familiar_fox_2")).formFlag(NoInhibitor, LockInstinct, CursedMoonFinalForm, NoCatalyst, CanTFToFinalForm).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.55f, 1.0f)));
    public static IForm FAMILIAR_FOX_3 = registerPlayerForm(new Form_FamiliarFox3(ShapeShifterCurseFabric.identifier("familiar_fox_3")).formFlag(FinalForm, NoAnyInhibitor, NoInstinct, NoCursedMoonEffect).bodyType(PlayerFormBodyType.FERAL).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.45f,0.6f)));
    ...
    public static IForm SNOW_FOX_2 = registerPlayerForm(new Form_SnowFox2(ShapeShifterCurseFabric.identifier("snow_fox_2")).formFlag(NoInhibitor, LockInstinct, CursedMoonFinalForm, NoCatalyst, CanTFToFinalForm).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.55f, 1.0f)));
    public static IForm SNOW_FOX_3 = registerPlayerForm(new Form_SnowFox3(ShapeShifterCurseFabric.identifier("snow_fox_3")).formFlag(FinalForm, NoAnyInhibitor, NoInstinct, NoCursedMoonEffect).bodyType(PlayerFormBodyType.FERAL).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.45f,0.6f)));
    ...
    public static IForm ANUBIS_WOLF_2 = registerPlayerForm(new NormalForm(ShapeShifterCurseFabric.identifier("anubis_wolf_2")).formFlag(NoInhibitor, LockInstinct, CursedMoonFinalForm, NoCatalyst, CanTFToFinalForm).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.9f, 1.0f)));
    public static IForm ANUBIS_WOLF_3 = registerPlayerForm(new Form_AnubisWolf3(ShapeShifterCurseFabric.identifier("anubis_wolf_3")).formFlag(FinalForm, NoAnyInhibitor, NoInstinct, NoCursedMoonEffect).bodyType(PlayerFormBodyType.FERAL).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.8f,0.6f)));
    ...
    // Spider
    public static IForm SPIDER_0 = registerPlayerForm(new NormalForm(ShapeShifterCurseFabric.identifier("spider_0")).formFlag(StarterForm, NoAnyCatalyst).applyScaleFunc(NormalForm.RESET_SCALE_FUNC));
    public static IForm SPIDER_1 = registerPlayerForm(new Form_Spider1(ShapeShifterCurseFabric.identifier("spider_1")).formFlag(NoCursedMoonTFTarget, NoCursedMoonEffect, NoAnyCatalyst).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.85f, 1.0f)));
    public static IForm SPIDER_2 = registerPlayerForm(new Form_Spider2(ShapeShifterCurseFabric.identifier("spider_2")).formFlag(NoInhibitor, LockInstinct, CursedMoonFinalForm, NoCatalyst, CanTFToFinalForm).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.9f, 1.0f)));
    public static IForm SPIDER_3 = registerPlayerForm(new Form_Spider3(ShapeShifterCurseFabric.identifier("spider_3")).formFlag(FinalForm, NoAnyInhibitor, NoInstinct, NoCursedMoonEffect).applyScaleFunc(NORMAL_SCALE_FUNC_BUILDER.apply(0.9f,0.6f)));
