...
public class SneakRushAnimController extends AbstractAnimStateControllerDP {
    ...
    AnimUtils.AnimationHolderData sneakRushAnimationHolderData;
    AnimationHolder sneakRushAnimationHolder = null;

    public SneakRushAnimController(@Nullable JsonObject jsonData) {
        super(jsonData);
    }

    public SneakRushAnimController(AnimUtils.AnimationHolderData animationHolderData, AnimUtils.AnimationHolderData sneakAnimationHolderData, AnimUtils.AnimationHolderData sneakRushAnimationHolderData) {
        super(null);
    ...
    public AbstractAnimStateController loadFormJson(JsonObject jsonObject) {
        ...
        if (jsonObject.has("sneakRushAnim") && jsonObject.get("sneakRushAnim").isJsonObject()) {
            this.sneakRushAnimationHolderData = AnimUtils.readAnim(jsonObject.get("sneakRushAnim").getAsJsonObject());
        }
        return this;
    }
}
