...
public class AlterRecipeOld implements Recipe<Inventory> {
    ...
    public static final AlterRecipeOld EmptyRecipe = new AlterRecipeOld(EmptyRecipeId, Ingredient.EMPTY, Ingredient.EMPTY, Ingredient.EMPTY, Ingredient.EMPTY, Ingredient.EMPTY, Ingredient.EMPTY, Ingredient.EMPTY, (inventory) -> new ArrayList<>(), 0);
    ...
    public AlterRecipeOld(Identifier id, Ingredient input1, Ingredient input2, Ingredient input3, Ingredient input4, Ingredient input5, Ingredient input6, Ingredient input7, Function<@Nullable Inventory, List<ItemStack>> output, int recipeTime) {
        this.id = id;
        this.input1 = input1;
        this.input2 = input2;
        this.input3 = input3;
    ...
    public static class Serializer implements RecipeSerializer<AlterRecipeOld> {
        public AlterRecipeOld read(Identifier identifier, JsonObject jsonObject) {
            try {
                ...
                return new AlterRecipeOld(identifier, input1, input2, input3, input4, input5, input6, input7, function, recipeTime);
        ...
        public AlterRecipeOld read(Identifier identifier, PacketByteBuf packetByteBuf) {
            try {
        ...
        public void write(PacketByteBuf packetByteBuf, AlterRecipeOld alterRecipe) {
