...
import net.onixary.shapeShifterCurseFabric.recipes.alter.AlterRecipeOld;
...
public class RecipeSerializerRegister {
    ...
    public static RecipeSerializer<AlterRecipeOld> ALTER_RECIPE = register(ShapeShifterCurseFabric.identifier("alter"), new AlterRecipeOld.Serializer());
